...
src/%.o: ../src/%.c src/subdir.mk
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -DCORE_M3 -D__USE_CMSIS=CMSISv2p00_LPC17xx -D__LPC17XX__ -D__REDLIB__ -I"D:\Facultad\Electronica Digital 3\worskpace\IngeniaTeam\inc" -I"D:\Facultad\Electronica Digital 3\worskpace\CMSISv2p00_LPC17xx\inc" -I"D:\Facultad\Electronica Digital 3\worskpace\CMSISv2p00_LPC17xx\Drivers\inc" -O0 -fno-common -g3 -gdwarf-4 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m3 -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
